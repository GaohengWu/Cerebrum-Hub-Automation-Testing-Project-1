...
describe('This is first test suite, John Smith', () => {
    ...
    it('User cannot submit data when username is absent', () => {
        ...
        cy.get('#firstName').type('Gaoheng')
        cy.get('#lastName').type('Wu')
    ...
    it('User cannot submit data when phone number is absent', () => {
        ...
        cy.get('[data-testid="phoneNumberTestId"]').should('have.attr', 'title').should('contain','Add phone number', 'Input field')
    ...
    it('User cannot submit data when password and/or confirmation password is absent', () => {
        ...
        // Assert that phone number has tooltip with error message
        cy.get('[name="confirm"]').should('have.attr', 'title').should('contain', 'Input field')
    ...
    it('User cannot add letters to phone number', () => {
        ...
        cy.get('[data-testid="phoneNumberTestId"]').type('123456x')
